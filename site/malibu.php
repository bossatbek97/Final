...
<link rel="stylesheet" href="css/malibu.css" type="text/css" media="all" />
...
<div class="shell">
  <div class="border">
    <div id="header">
      <h1 id="logo"><a href="#" class="notext">SMART</a></h1>
      ...
      <ul>
        <li>
          <div class="item">
            ...
            <img src="css/images/malibu3.jpg" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/bb.jpg" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/1.jpg" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/salon1.jpg" alt="" /> </div>
        </li>
      </ul>
    </div>
    <div id="main">
      <div id="content" class="left">
        <div class="highlight">
          ...
          <h3>НОВЫЙ MALIBU. РОСКОШЬ, КОТОРУЮ ВЫ МОЖЕТЕ СЕБЕ ПОЗВОЛИТЬ

</h3>
          <p>Chevrolet Malibu появился на американских дорогах еще в 1964 году, и за прошедшее с тех пор время этот седан завоевал множество международных наград. Новый Malibu — это автомобиль, который Вы заслуживаете. Он невероятно комфортабелен, оснащен новейшими технологиями и исключительно хорош в управлении.</p>
        <h3>АЭРОДИНАМИЧЕСКИЙ ДИЗАЙН</h3>
        <p>Аэродинамичный дизайн нового Malibu не только выглядит привлекательно, но и выполняет очень важную роль, помогая свести к минимуму шум и вибрацию, а также повысить топливную экономичность. Каждая стремительная линия и изгиб кузова Chevrolet Malibu спроектированы так, чтобы улучшить динамические показатели автомобиля, одновременно подчеркивая красоту и благородство дизайна. Это воплощено и в силуэте автомобиля, напоминающем купе, и в каждой его детали.</p>
        <div class="projects">
          <h3>Модели</h3>
          <div class="item">
