...
<link rel="stylesheet" href="css/aveo.css" type="text/css" media="all" />
      ...
      <ul>
        <li>
          <div class="item">
            ...
            <img src="css/images/aveo1jpg.jpg" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/aveo.png" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/red.jpg" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
    ...
    <div id="main">
      <div id="content" class="left">
        <div class="highlight">
          ...
          <h3>НАПОЛНИТЕ ЖИЗНЬ ВПЕЧАТЛЕНИЯМИ С НОВЫМ СЕДАНОМ AVEO</h3>
          <p>Городской седан Aveo обладает всеми качествами, присущими автомобилям Chevrolet: элегантным продуманным дизайном, спортивной управляемостью, топливной экономичностью, универсальностью и безопасностью, подтвержденной лучшим в категории компактных автомобилей рейтингом Euro NCAP 2011. Aveo — это отличный выбор. Aveo — это компактный седан, замечательный во всех отношениях.</p>
        <h3>УДОБНОЕ БАГАЖНОЕ ОТДЕЛЕНИЕ</h3>
        <p>Chevrolet Aveo спроектирован с применением самых современных решений и предлагает максимальное удобство при перевозке грузов. Объем багажника седана Aveo составляет 502 литра — в него легко поместится вся ваша спортивная экипировка или покупки на целую неделю, а удобные крючки позволят надежно закрепить ваш багаж во время движения.</p>
        <div class="projects">
          <h3>Модели</h3>
          <div class="item">
