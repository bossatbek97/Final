...
<link rel="stylesheet" href="css/cruze.css" type="text/css" media="all" />
      ...
      <ul>
        <li>
          <div class="item">
            ...
            <img src="css/images/chevrolet.jpg" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/cruze1.png" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/cruze.png" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/salon.jpg" alt="" /> </div>
        </li>
      </ul>
    </div>
    <div id="main">
      <div id="content" class="left">
        <div class="highlight">
          ...
          <h3>ВПЕЧАТЛЯЮЩИЙ СЕДАН CHEVROLET CRUZE — НОВЫЕ ПРАВИЛА ИГРЫ</h3>
          <p>Chevrolet Cruze седан открывает дорогу в новое глобальное будущее. Этот поистине международный автомобиль заслужил признание и любовь автовладельцев в 199 странах мира. Стильный и современный дизайн, превосходные технические характеристики и харизма позволили Шевроле Круз стать самой продаваемой моделью Шевроле.
...
Шевроле Круз выделяется в сегменте городских автомобилей своим комфортабельным салоном, запоминающейся внешностью и пятью звездами в рейтинге безопасности NCAP.</p>
        <h3>ДВИГАТЕЛЬ</h3>
        <p>Автомобиль Шевроле Круз седан доступен с двумя бензиновыми двигателями: 1,6 л (124 л.с.) и 1,8 л (141 л.с.). Они поставляются с 5-скоростной ручной и 6-скоростной автоматической коробкой передач и соответствуют стандарту Евро-4.</p>
        <div class="projects">
          <h3>Модели</h3>
          <div class="item">
...
Шевроле Круз выделяется в сегменте городских автомобилей своим комфортабельным салоном, запоминающейся внешностью и пятью звездами в рейтинге безопасности NCAP.</p>
              <a href="#" class="cruze.php">Подробнее</a> </div>
            <div class="cl">&nbsp;</div>
          </div>          
        </div>
      </div>
